...
export type ServerBackend = 'aniheist' | 'megaplay' | 'reanime' | 'filmu' | 'megaplaysu';
...
export const SERVERS: StreamServer[] = [
  ...
  { id: 'altair', label: 'Altair', note: 'External player · sub and dub',                backend: 'megaplaysu', embed: true },
];
