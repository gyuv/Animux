...
export default async function HomePage() {
  ...
  /*
   * What is already out to watch. The catalogue publishes the *next* episode,
   * not the last one, so the episode currently available is the one before it.
   * Titles without that field are left out rather than guessed at.
   */
  ...
  /* The three rankings this catalogue can actually answer. */
  const boards = [
